...
class VAE(object):
    ...
    def _create_loss_optimizer(self):
        ...
        self.cost = tf.add(tf.reduce_mean(NL + KLD), tf.reduce_mean(tf.reduce_sum(tf.multiply(self.l2_strength, regularizer), 1)))
    ...
    def test(self, X):
        ...
        """
        l2_strength = np.zeros_like(self.network_weights['beta'].values)
